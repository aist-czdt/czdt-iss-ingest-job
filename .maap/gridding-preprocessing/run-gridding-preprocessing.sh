...
# CZDT ISS Gridding Preprocessing - Pipeline Runner
...
echo "Executing: python ${root_dir}/src/preprocess_gridding_pipeline.py ${args[@]}"
conda run -n ingest --live-stream python "${root_dir}/src/preprocess_gridding_pipeline.py" "${args[@]}"